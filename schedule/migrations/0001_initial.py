...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeAway'
        db.create_table(u'schedule_timeaway', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('type', self.gf('django.db.models.fields.CharField')(default='OOO', max_length=4)),
        ))
        db.send_create_signal(u'schedule', ['TimeAway'])


    def backwards(self, orm):
        # Deleting model 'TimeAway'
        db.delete_table(u'schedule_timeaway')
    ...
    models = {
        ...
        u'schedule.timeaway': {
            'Meta': {'object_name': 'TimeAway'},
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'OOO'", 'max_length': '4'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Person']"})
        },
        u'taggit.tag': {
